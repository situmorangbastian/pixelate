...
func (_m *ImageService) Compress(file string) (string, error) {
	ret := _m.Called(file)
...
func (_m *ImageService) ConvertPngToJpg(file string) (string, error) {
	ret := _m.Called(file)
...
func (_m *ImageService) Resize(file string, scale string) (string, error) {
